...
ttk.Button(button_frame, text="New Game", compound="left",
           command=start_new_game).grid(row=0, column=0, padx=10)
ttk.Button(button_frame, text="Load Game", compound="left",
           command=load_game).grid(row=0, column=1, padx=10)
